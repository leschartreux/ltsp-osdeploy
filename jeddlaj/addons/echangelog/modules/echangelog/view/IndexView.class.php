...
/**
 * Vue par défaut du module echangelog
 *
 * @category   Outils_Administration
 * @package    E-changelog
 * @subpackage View
...
class IndexView extends View
{
    ...
    {
        $this->_content .= '<p><a href="index.php?module=echangelog&amp;action=upload">Uploader un fichier de log, un script de postinstall ou un script de prédéinstall</a></p>';

        $this->_content .= '<p><a href="index.php?module=echangelog&amp;action=search">Rechercher un fichier de log, un script de postinstall ou un script de prédéinstall</a></p>';
