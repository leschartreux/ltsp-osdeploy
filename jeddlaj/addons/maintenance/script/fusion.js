...
$("form").submit(function() {
    ...
    nbRadio = $("input[type='radio']").length;

    nbChecked = countChecked();   

    if (nbRadio / 2 == nbChecked) {

	return true;

    } else {

	$("#notification").append("Sélectionnez un bouton radio pour chaque logiciel<br />").show();
	return false;
    }
});
