...
/******************************************************
 *                                                    *
 *      traitement du formulaire de l'étape 8         *
 *                                                    *
 ******************************************************/
$idbDiff = false;
...
if ($idbDiff) {
    ...
    $content .= 'Pour passer à l\'étape suivante vous devez effectuer une des actions suivantes pour chaque image de base concernée : <br \>';

    $content .= '<ul>';

    $content .= '<li>Changer la spécificité ou la valeur de la spécificité de l\'image de base locale ou distante. (Les changements sur la base distante nécéssitent de réimporter la base)</li>';

    $content .= '<li>Supprimer l\'image de base locale</li>';
    ...
    /*********************************************
     *                                           *
     *      Formulaire de l'étape 9              *
     *                                           *
     *********************************************/
    $content .= '<h2>Recherche des images de base identiques</h2>';

    $sql = 'INSERT INTO `fusion` (prefixe, etape) VALUES ("'.$prefix.'", 9)';
    ...
    $sql = 'SELECT a.id_idb, '.
           ...
           'INNER JOIN `'.$prefix.'_images_de_base` AS b '.
    ...
    if ($nbResult > 0) {
        ...
        $content .= '<p>Dans cette étape, on recherche les images de base ayant la même spécificité mais une valeur de spécificité différente.<br />Dans ce formulaire : cochez oui pour remplacer les images de base distantes par les images de base locales.</p>';
        ...
        $content .= '<p><a href="step10.php">Suivant</a></p>';
    }
 }
