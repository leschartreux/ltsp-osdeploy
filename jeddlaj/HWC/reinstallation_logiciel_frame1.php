...
entete("Gérard Milhaud & Frédéric Bloise : La.Firme@esil.univ-mrs.fr", "../CSS/g.css", "JeDDLaJ : Réinstallation/Désinstallation d'un logiciel");
include ("../DBParDefaut.php");
ConnectMySQL($GLOBALS['host'], $GLOBALS['user'], $GLOBALS['pwd']);
SelectDb($GLOBALS['db']);

print("<CENTER><H1>Réinstallation/Désinstallation d'un logiciel</H1></CENTER>\n");

print("<CENTER>\n");
print("<TABLE>\n");
print("<FORM METHOD=POST NAME=\"form\" ACTION=\"reinstallation_logiciel_frame2.php\" TARGET=\"selection\">\n");
print("<TR>\n<TD>Logiciel : </TD>\n");
print("<TD><SELECT name=\"id_logiciel\" onChange=\"javascript:document.form.submit();\">\n");
$request = "SELECT nom_logiciel,version,nom_os,a.id_logiciel FROM logiciels AS a, packages AS b WHERE a.id_logiciel=b.id_logiciel GROUP BY a.id_logiciel ORDER BY nom_os,nom_logiciel,version";
