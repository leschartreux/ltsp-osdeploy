...
print("<H2><A HREF=\"depannage_mode_admin.php\">Mise en dépannage mode administrateur</A>/<A HREF=\"sortie_en_cours.php\">Sortie de l'état en cours vers l'état dépannage</A></H2>\n");
